...
public class InputFiles {
	...
	public static void main(String[] args) throws IOException {
		...
		if(sfile.exists())
		{
			...
			{
				System.out.println("The destination file already exists do you want to overwrite the content, press 1 for overwrite and 0 for append");
				int choice = in.nextInt();
				in.nextLine();
				if(choice ==1) {
					FileReader fr = new FileReader(sourceName);
					BufferedReader br = new BufferedReader(fr);
					FileWriter fw = new FileWriter(destinationName, false);
					String s;
		...
		{
			System.out.println("Source file doesn't exist making a new one");
			sfile.createNewFile();
			}
