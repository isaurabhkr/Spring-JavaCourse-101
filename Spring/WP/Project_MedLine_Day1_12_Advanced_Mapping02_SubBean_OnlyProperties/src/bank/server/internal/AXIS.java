...
public class AXIS implements Bank {
	...
	public String toString() {
		return "AXIS [accountRepo=" + accountRepo + ", bankName=" + bankName + ", branchCode=" + branchCode
				+ ", accountTypes=" + accountTypes + "]";
	}

	private AXIS(AccountRepository accountRepo,Properties acctTypes) {
		super();
		this.accountRepo = accountRepo;
		this.accountTypes = acctTypes;
		System.out.println("Private Overloaded constructor AXIS called");
	}
